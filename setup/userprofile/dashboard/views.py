...
def dashboard(request):
    ...
    #this exception clause is very broad but it covers the possible exceptions that could be raised by the above which would be solved by confirming profile info
